...
- [ ] **Step 1: Write failing tests for explicit logo-key and logo-variant selection**
...
- [ ] **Step 1: Add helpers for listing keys and variants**
...
- [ ] **Step 2: Preserve EXIF-derived fallback**
...
- [ ] **Step 1: Write the smallest failing test or assertion update for preview inputs**
...
- [ ] **Step 2: Add global Logo controls in the panel**
...
- [ ] **Step 1: Add request/config fields needed by export**

Make sure export receives `logoKey` and `logoVariant`.

- [ ] **Step 2: Implement minimal Rust-side SVG logo loading strategy**
...
- [ ] **Step 4: Record the user-visible behavior in `CHANGELOG.md`**
